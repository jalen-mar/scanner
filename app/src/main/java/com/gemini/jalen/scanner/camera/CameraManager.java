 ...
 */
package com.gemini.jalen.scanner.camera;
...
public final class CameraManager {
     ...
     */
    public synchronized void openDriver(SurfaceHolder holder, int rotation) throws IOException {
        ...
        // 设置摄像头预览view方向
        setDisplayOrientation(theCamera, rotation);
    ...
    private void setDisplayOrientation(Camera camera, int rotation) {
        ...
        camera.setDisplayOrientation((info.orientation - degress + 360) % 360);
    }
